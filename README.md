...
6. Finish tactical systems: complete original AI scripts, full vehicle driving/traffic, all weapons/accessories, persuasion, destructibility, XMI music playback plus complete sound mapping, and fully decoded original sidebar controls beyond the current selector/icon sprite ranges.
